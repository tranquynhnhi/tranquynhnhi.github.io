  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a  href="http://localhost:4000/chamcon/experiences/">Experiences</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000/chamcon/Communications/">Communications</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000/chamcon/Education/">Education</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/chamcon/Hobby/">Hobby</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/chamcon/hobby/cooking/">Cooking</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/chamcon/hobby/piano">Piano</a></li>
